...
def register_custom_actions():
    ...
    # 启动游戏相关
    AgentServer.register_custom_action("ActivateWeGameWindow", ActivateWeGameWindow())
    AgentServer.register_custom_action("CheckGameProcess", CheckGameProcess())
    AgentServer.register_custom_action("OpenBrowserAndFocus", OpenBrowserAndFocus())
